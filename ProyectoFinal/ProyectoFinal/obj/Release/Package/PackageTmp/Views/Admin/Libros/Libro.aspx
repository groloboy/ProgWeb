...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="form-group">
            <label for="txtTitulo" class="control-label">Titulo del libro</label>
            <asp:TextBox runat="server" ID="txtTitulo" class="form-control" requiered="true" Width="350" />
        </div>
        <br />
        <div class="form-group">
            <label for="txtCodigo" class="control-label">Codigo de clasificación: </label>
            <asp:TextBox runat="server" ID="txtCodigo" class="form-control" requiered="true" Width="300" />
        </div>
        <br />
        <div class="form-group">
            <label for="txtEstante" class="control-label">Seccion: </label>
