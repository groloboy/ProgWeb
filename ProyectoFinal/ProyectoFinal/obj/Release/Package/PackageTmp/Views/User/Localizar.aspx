...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container img-thumbnail organizar">
        ...
        <div class="row">
            <div class="col-12">
                <label>Aqui puedes localizar tu libro teniendo el codigo de un libro previamente consultado en <a href="http://biblioteca.uao.edu.co/F/-/?func=find-b-0">Catálogo UAO</a></label>
                <label>El formato del codigo debe ser: [418.007 A362L] para evitar errores en tu búsqueda.</label>
            </div>
        </div>
        <div class="row">
            <div class="col-3">
